...
public class main {
    ...
    public static void main(String[] args) throws Exception {
        ...
        nursery.addAnimal(new Dog("Бобик", "2021-01-27"));
        nursery.addAnimal((new Cat("Снежок", "2022-04-25")).addSkill("ловить мышей"));
        nursery.addAnimal(new Hamster("Тигр", "2020-10-17"));
    ...
    private static String inputName() {
        String name = "";
        while (name.equals("")) {
            System.out.print("Введите кличку питомца: ");
    ...
    public static int mainMenu() {
        ...
        System.out.println("1 - Список питомцев, живущих в питомнике");
        System.out.println("2 - Информация о питомце");
        System.out.println("3 - Добавление питомца");
        System.out.println("4 - Удаление питомца");
