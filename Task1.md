...
```
yana@gb-linux:~$ cat PackAnimals >> Pets
yana@gb-linux:~$ cat Pets
dogs
cats
hamsters
...
```
yana@gb-linux:~$ mv Pets HumansFriends
yana@gb-linux:~$ cat HumansFriends
dogs
cats
hamsters
horses
...
```
yana@gb-linux:~$ mkdir newdir
yana@gb-linux:~$ mv HumansFriends newdir/
yana@gb-linux:~$ cat HumansFriends
cat: HumansFriends: No such file or directory
yana@gb-linux:~$ cat newdir/HumansFriends
dogs
cats
hamsters
horses
...
1. Скачать файл
```
yana@gb-linux:~$ wget https://repo.mysql.com//mysql-apt-config_0.8.24-1_all.deb
...
```
yana@gb-linux:~$ sudo dpkg -i mysql-apt-config_0.8.24-1_all.deb
...
4. Установка MySQL
```
yana@gb-linux:~$ sudo apt install -y mysql-server
Reading package lists... Done
Building dependency tree... Done
Reading state information... Done
...
5. Проверка
```
yana@gb-linux:~$ systemctl status mysql
...
```
yana@gb-linux:~$ wget https://go.skype.com/skypeforlinux-64.deb
...
2. Установка
```
yana@gb-linux:~$ sudo dpkg -i skypeforlinux-64.deb
...
3. Проверка
```
yana@gb-linux:~$ apt list | grep skype
...
4. Удаление
```
yana@gb-linux:~$ sudo dpkg -r skypeforlinux
(Reading database ... 126536 files and directories currently installed.)
